...
#? global dnf install
sudo dnf -y install python python3 python-pip python3-pip gcc-c++ make gcc nodejs git golang dnf-plugins-core
sudo dnf -y install java-1.8.0-openjdk.x86_64 java-11-openjdk.x86_64 java-latest-openjdk.x86_64
