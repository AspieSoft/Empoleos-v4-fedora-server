...
# echo 'export CGO_ENABLED="0"' | sudo tee -a "/etc/profile.d/golang.sh" # setting CGO_ENABLED to 0 fixes cross compatibility issues with the binary file generated by "go build"

# echo 'export PATH="$PATH:$HOME/zig"' | sudo tee -a "/etc/profile.d/golang.sh" # setting CGO_ENABLED to 0 fixes cross compatibility issues with the binary file generated by "go build"
# echo 'export CGO_ENABLED="1"' | sudo tee -a "/etc/profile.d/golang.sh" # setting CGO_ENABLED to 0 fixes cross compatibility issues with the binary file generated by "go build"
# echo 'export CC="zig cc -target x86_64-linux"' | sudo tee -a "/etc/profile.d/golang.sh" # setting CGO_ENABLED to 0 fixes cross compatibility issues with the binary file generated by "go build"
# echo 'export CXX="zig c++ -target x86_64-linux"' | sudo tee -a "/etc/profile.d/golang.sh" # setting CGO_ENABLED to 0 fixes cross compatibility issues with the binary file generated by "go build"
